...
namespace WindGhC
{
    public class SnappyHexMeshDict : GH_Component
    {
        ...
        {
            pManager.AddGenericParameter("snappyHexMeshDict", "sHM", "Generated snappyHexMeshDict file", GH_ParamAccess.item);
        }
        ...
        protected override void SolveInstance(IGH_DataAccess DA)
        {
            ...
            {
                AddRuntimeMessage(GH_RuntimeMessageLevel.Error, "Specify a point defining a location in the computational domain.");
            }
            ...
            foreach (GH_Path path in convertedGeomTree.Paths)
            {
                ...
                eMeshString +=
                    ...
                    "         level " + convertedGeomTree.Branch(path)[0].GetUserString("eMeshLvl") + ";\n" +
                    "       }\n\r";
        ...
        protected override System.Drawing.Bitmap Icon
        {
            get
            {
                ...
                return Properties.Resources.snappyHexMesh;
            }
        }
