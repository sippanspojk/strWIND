...
namespace WindGhC
{
    public class Assembly : GH_Component
    {
        ...
        protected override void RegisterInputParams(GH_Component.GH_InputParamManager pManager)
        {
            ...
            pManager.AddBrepParameter("Domain", "D", "Input the domain.", GH_ParamAccess.tree);
            ...
            pManager.AddGenericParameter("WIND", "W", "If turbulent wind profile is used, then insert the generated 3c3d... file here.", GH_ParamAccess.item);
